...
const ProductReview = ({ productId }) => {
  ...
  const { getReviewDocument } = useFirebase()
  ...
  if (visibleReviews.length === 0) {
    console.log("elllwpee04emsmks")
    return (
      <div className="box3  w-full h-auto py-10 flex justify-center items-center flex-col gap-5">
        <h1 className='text-2xl text-center font-semibold'>There is no reviews yet</h1>
