...
const FiveInOneLayout = () => {
  ...
  return (
    <div className='flex relative'>
      <div className={`absolute duration-700 sm:relative ${isSideBarOpen} bg-white z-40 w-1/2  shadow-lg h-full sm:w-[15%] sm:left-0 sm:px-5 sm:py-16 sm:border-r sm:flex justify-end sm:h-[70vh] items-center `}>
